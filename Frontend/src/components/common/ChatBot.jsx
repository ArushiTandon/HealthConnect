...
const ChatBotModal = ({ isOpen, onClose }) => {
  ...
  const askBot = async () => {
    ...
    setConversationHistory((prev) => [
      ...prev,
      { type: "user", message: currentQuestion },
    ]);
    setQuestion("");
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">
                    Get instant answers about hospital services and facilities
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                {conversationHistory.length > 0 && (
                  <button
                    onClick={clearChat}
                    className="px-4 py-2 bg-white bg-opacity-20 hover:bg-slate-600 rounded-lg transition-all duration-200 text-black text-sm font-medium"
                  >
                    Clear Chat
                  </button>
                )}
                <button
                  onClick={handleClose}
                  className="p-2 bg-white text-red-700 bg-opacity-20 hover:text-white hover:bg-red-600 rounded-lg transition-all duration-200"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
              ...
              <div className="flex items-center justify-center h-full text-center p-8">
                <div className="max-w-md">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">
                    Hey there! Healix here.
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Ask me anything about hospital services, departments,
                    facilities, or general medical information.
                  </p>
                  <div className="bg-white rounded-lg p-4 shadow-sm border">
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      ...
                      <li>• "Which hospitals offer dialysis in Hyderabad?"</li>
                      <li>
                        • "Give me the contact number of Harmony Super
                        Speciality Hospital."
                      </li>
                    </ul>
                  </div>
          ...
          <div className="bg-white border-t border-gray-200 rounded-b-2xl p-4 shadow-sm flex-shrink-0">
            ...
            <div className="mt-3 text-center">
              <p className="text-xs text-gray-500">
                💡 This AI assistant provides general information. For medical
