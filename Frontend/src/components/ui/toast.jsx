...
// You can still export types like this in JS if needed (just for consistency in other files):
// const ToastProps = {}; const ToastActionElement = {}; // comment this if unused
