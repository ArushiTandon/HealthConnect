import { Hospital, Search, MapPin, Phone, Clock, Star, Heart, Stethoscope, Zap, Shield, Users, Bed, Car, Building, ChevronRight, MessageCircle, Award, Activity } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Connect with hospitals in real-time. Check bed availability, facilities, and get the care you need when you need it most.
            </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 mb-12">
              ...
              <div className="mt-4 flex flex-wrap gap-2 justify-center">
                <Badge variant="secondary" className="bg-blue-100 text-blue-800">Emergency Care</Badge>
                <Badge variant="secondary" className="bg-green-100 text-green-800">ICU Available</Badge>
                <Badge variant="secondary" className="bg-purple-100 text-purple-800">Specialized Care</Badge>
                <Badge variant="secondary" className="bg-orange-100 text-orange-800">24/7 Service</Badge>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                We make finding healthcare simple, fast, and reliable when every second counts.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-2 border-blue-100 hover:border-blue-300 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-gray-900">Real-Time Updates</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                    Get instant updates on bed availability, wait times, and hospital capacity directly from healthcare providers.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-green-100 hover:border-green-300 transition-colors">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Find hospitals with specialized facilities including ICU, emergency care, surgery centers, and more.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-purple-100 hover:border-purple-300 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-gray-900">Location-Based</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                    Discover nearby hospitals with turn-by-turn directions and estimated travel times for urgent situations.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Join thousands of hospitals and millions of patients using HealthConnect
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Start your search now and connect with available healthcare providers in your area.
            </p>
      ...
      {/* ... keep existing code (Footer remains the same) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Connecting patients with healthcare providers for better, faster care.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Update Availability</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Manage Facilities</a></li>
              </ul>
            </div>
            <div>
