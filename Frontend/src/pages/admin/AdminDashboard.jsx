          ...
          <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600">
                    Available: {dashboardData.availableBeds || 0}
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600">
                    Showing current active services
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <div
                    className={`text-3xl font-bold ${
                      dashboardData.metrics?.criticalOccupancy
                        ? "text-red-600"
                        : "text-green-600"
                    }`}
                  >
                  ...
                  <p className="text-sm text-gray-600">
                    Emergency Beds: {dashboardData.emergencyBeds || 0}
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent className="flex flex-wrap gap-4">
                ...
                <Button
                  onClick={() => setActiveSection("hospital-info")}
                  variant="outline"
                >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Manage your hospital's information and availability
                  </p>
                </div>
              </div>
