...
import { Calendar, Clock, Phone, MapPin, RotateCcw, Plus, ChevronDown, Search, ArrowLeft } from 'lucide-react';
...
const UserAppointments = () => {
  ...
  const handleBookAppointment = async (formData) => {
    try {
      ...
      const response = await appointmentApi.createAppointment(hospitalId, date, time, reason);
      ...
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-600">Loading appointments...</h3>
          </div>
        </div>
      </div>
    );
            ...
            <div key={appointment._id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-start space-x-4">
                  <div className="text-2xl mt-1">{getSpecialtyIcon(appointment.reason)}</div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 text-sm text-gray-600">
                      ...
                      <div className="flex items-center space-x-2">
                        <MapPin size={14} />
                        <span className="font-medium">{appointment.hospitalId?.address}</span>
                      </div>
